...
$strSQL = "SELECT * ,SUM(bill_bet) AS betplay
			FROM tb_bill 
			WHERE lot_type_id = 10 OR lot_type_id = 11 OR lot_type_id = 12 OR lot_type_id = 13 
			GROUP BY tb_bill.bill_number ";
...
$c->addTitle("รายงานการซื้อหวย 2 ตัว", "tahomabd.ttf", 10, 0x0000ff);
...
$dataSetObj = $layer->addDataSet($data, 0x0000ff, "2 ตัวหน้าเต็ง");
$dataSetObj1 = $layer->addDataSet($data1, 0xff0000, "2 ตัวหน้าโต๊ด");
$dataSetObj2 = $layer->addDataSet($data2, 0x00ff00, "2 ตัวหลังเต็ง");
$dataSetObj3 = $layer->addDataSet($data3, 0xFA8258, "2 ตัวหลังโต๊ด");
